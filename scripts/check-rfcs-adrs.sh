...
if [[ ${1:-} == --self-test ]]; then
  ...
  reset_fixture; perl -0pi -e 's/- Status: (?:Draft|Review|Accepted)/- Status: Accepted/; s|- Discussion: .*|- Discussion: https://github.com/kan-tools/day/pull/7|; s/- Review-started-at: .*/- Review-started-at: 2026-08-01T00:00:00Z/; s/- Review-period-ends: .*/- Review-period-ends: 2026-08-01T01:00:00Z/; s/- Review-override: .*/- Review-override: None/' "$fixture/rfcs/0-rfc-and-adr-process.md"; perl -0pi -e 's/0-rfc-and-adr-process.md\) — (?:Draft|Review|Accepted)/0-rfc-and-adr-process.md) — Accepted/' "$fixture/rfcs/README.md"; expect_rejected short-review 'fewer than 72 review hours elapsed'
